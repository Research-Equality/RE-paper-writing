...
- Planning prompts: `references/planning-prompts.md`
- Output schemas and templates: `references/output-schemas.md`
...
## Related Skills
- Upstream: [literature-search](../literature-search/), [literature-review](../literature-review/)
- Downstream: [paper-writing-section](../paper-writing-section/), [survey-generation](../survey-generation/)
- See also: [systematic-review](../systematic-review/), [paper-memory-ledger](../paper-memory-ledger/), [experiment-report-bridge](../experiment-report-bridge/)
