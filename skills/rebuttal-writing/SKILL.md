...
- Rebuttal prompts and format templates: `references/rebuttal-prompts.md`
...
- See also: [citation-management](../citation-management/), [paper-redline-diff](../paper-redline-diff/), [submission-qa-gate](../submission-qa-gate/)
