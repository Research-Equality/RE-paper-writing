...
```bash
python skills/self-review/scripts/extract_pdf_text.py paper.pdf --output paper_text.txt
python skills/self-review/scripts/extract_pdf_text.py paper.pdf --format markdown
```
...
```bash
python skills/self-review/scripts/parse_pdf_sections.py \
...
- NeurIPS review form, scoring weights, personas, reflection prompts: `references/review-form.md`
- PDF text extraction: `scripts/extract_pdf_text.py`
...
## Related Skills
- Upstream: [paper-compilation](../paper-compilation/), [ml-paper-writing](../ml-paper-writing/)
- Downstream: [paper-revision](../paper-revision/), [rebuttal-writing](../rebuttal-writing/)
- See also: [paper-writing-section](../paper-writing-section/), [review-ensemble](../review-ensemble/), [reporting-guidelines-check](../reporting-guidelines-check/), [venue-submission-strategy](../venue-submission-strategy/), [claim-rigor-audit](../claim-rigor-audit/), [manuscript-scorecard](../manuscript-scorecard/), [reverse-outline-flow-check](../reverse-outline-flow-check/), [claim-evidence-map](../claim-evidence-map/), [experiment-section-audit](../experiment-section-audit/)
