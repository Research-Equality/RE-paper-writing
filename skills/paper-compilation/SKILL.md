...
- The main problem is that the manuscript does not build cleanly
- You need to debug LaTeX, BibTeX, missing figures, or broken environments
- The task is build/debug focused rather than overall submission readiness

For the overall pre-submission gate, use `submission-qa-gate`.
...
### Compile paper
```bash
python skills/paper-compilation/scripts/compile_paper.py paper/main.tex
python skills/paper-compilation/scripts/compile_paper.py paper/main.tex --check-style
python skills/paper-compilation/scripts/compile_paper.py paper/main.tex --output paper/output.pdf
```
...
```bash
python skills/paper-compilation/scripts/fix_latex_errors.py \
...
```bash
python skills/paper-compilation/scripts/compile_paper.py paper/main.tex --auto-fix
```
...
## Related Skills
- Upstream: [latex-formatting](../latex-formatting/), [citation-management](../citation-management/), [table-generation](../table-generation/), [latex-writeup-loop](../latex-writeup-loop/), [submission-qa-gate](../submission-qa-gate/)
- Downstream: [self-review](../self-review/)
- See also: [paper-revision](../paper-revision/), [rebuttal-writing](../rebuttal-writing/), [paper-redline-diff](../paper-redline-diff/)
