...
- Literature review workflow: `references/review-workflow.md`
...
- See also: [survey-generation](../survey-generation/), [source-material-ingestion](../source-material-ingestion/)
